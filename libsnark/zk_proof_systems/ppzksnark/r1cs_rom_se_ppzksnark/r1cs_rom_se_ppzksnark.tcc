...
template <typename ppT>
r1cs_rom_se_ppzksnark_keypair<ppT> r1cs_rom_se_ppzksnark_generator(const r1cs_rom_se_ppzksnark_constraint_system<ppT> &r1cs)
{
    libff::enter_block("Call to r1cs_rom_se_ppzksnark_generator");
    ...
    libff::leave_block("Call to r1cs_rom_se_ppzksnark_generator");
...
{
    libff::enter_block("Call to r1cs_rom_se_ppzksnark_prover");
    ...
    libff::leave_block("Call to r1cs_rom_se_ppzksnark_prover");
...
{
    libff::enter_block("Call to r1cs_rom_se_ppzksnark_verifier_process_vk");
    ...
    libff::leave_block("Call to r1cs_rom_se_ppzksnark_verifier_process_vk");
...
{
    libff::enter_block("Call to r1cs_rom_se_ppzksnark_online_verifier_weak_IC");
    ...
    libff::leave_block("Call to r1cs_rom_se_ppzksnark_online_verifier_weak_IC");
...
bool r1cs_rom_se_ppzksnark_verifier_weak_IC(const r1cs_rom_se_ppzksnark_verification_key<ppT> &vk,
                                        ...
                                        const r1cs_rom_se_ppzksnark_proof<ppT> &proof)
{
    libff::enter_block("Call to r1cs_rom_se_ppzksnark_verifier_weak_IC");
    ...
    libff::leave_block("Call to r1cs_rom_se_ppzksnark_verifier_weak_IC");
    return result;
}
...
{
    bool result = true;
    libff::enter_block("Call to r1cs_rom_se_ppzksnark_online_verifier_strong_IC");
    ...
    {
        result = r1cs_rom_se_ppzksnark_online_verifier_weak_IC(pvk, primary_input, proof);
    }

    libff::leave_block("Call to r1cs_rom_se_ppzksnark_online_verifier_strong_IC");
    return result;
}
...
bool r1cs_rom_se_ppzksnark_verifier_strong_IC(const r1cs_rom_se_ppzksnark_verification_key<ppT> &vk,
                                          ...
                                          const r1cs_rom_se_ppzksnark_proof<ppT> &proof)
{
    libff::enter_block("Call to r1cs_rom_se_ppzksnark_verifier_strong_IC");
    r1cs_rom_se_ppzksnark_processed_verification_key<ppT> pvk = r1cs_rom_se_ppzksnark_verifier_process_vk<ppT>(vk);
    bool result = r1cs_rom_se_ppzksnark_online_verifier_strong_IC<ppT>(pvk, primary_input, proof);
    libff::leave_block("Call to r1cs_rom_se_ppzksnark_verifier_strong_IC");
    return result;
}
...
bool r1cs_rom_se_ppzksnark_affine_verifier_weak_IC(const r1cs_rom_se_ppzksnark_verification_key<ppT> &vk,
                                               ...
                                               const r1cs_rom_se_ppzksnark_proof<ppT> &proof)
{
    libff::enter_block("Call to r1cs_rom_se_ppzksnark_affine_verifier_weak_IC");
    ...
    libff::leave_block("Call to r1cs_rom_se_ppzksnark_affine_verifier_weak_IC");
